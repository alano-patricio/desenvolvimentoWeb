...
defaultDots:k,defaultOptions:{length:6,regenerate:"Clique para mudar",hashName:"{n}Hash",dot:"*",dots:k,chars:"ABCDEFGHIJKLMNOPQRSTUVWXYZ"},_challengeClass:"realperson-challenge",_disabledClass:"realperson-disabled",_hashClass:"realperson-hash",_regenerateClass:"realperson-regen",_textClass:"realperson-text",_optionsChanged:function(a,c,b){d.extend(c.options,b);var g="";for(b=0;b<c.options.length;b++)g+=c.options.chars.charAt(Math.floor(Math.random()*c.options.chars.length));var e=this;a.closest("form").off("."+
