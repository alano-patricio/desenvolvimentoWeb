...
<form action="index.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="row"> 
        ...
        <div class="form-group col-sm-1">
            ...
            <?php
            echo isset($_POST['editarProduto']) ? '<input type="file" class="btn btn-primary" name="fotoProduto">' :
        ...
        <?php echo isset($_POST['editarProduto']) ? '<div class="panel-body  col-md-offset-2 col-md-2">
            <div id="noticia1"><img src="' . $preencheProduto['imagem'] . '" class=" img-responsive previewNoticia">
